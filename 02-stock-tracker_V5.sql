-- -----------------------------------------------------
-- Schema web_medicine_tracker
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `web_medicine_tracker`;

CREATE SCHEMA `web_medicine_tracker`;
USE `web_medicine_tracker` ;

-- -----------------------------------------------------
-- Table `web_medicine_tracker`.`stock`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `web_medicine_tracker`.`stock` (
...
-- -----------------------------------------------------
-- Table `web_medicine_tracker`.`pharmacist`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `web_medicine_tracker`.`pharmacist` (
    `id` int NOT NULL AUTO_INCREMENT,
...
insert into pharmacist (id,userName,pwd,isAdmin)
values ('2','Vishal','poo',false);



-- -----------------------------------------------------
-- Table `web_medicine_tracker`.`customer`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `web_medicine_tracker`.`customer` (
    `id` int NOT NULL AUTO_INCREMENT,
...
values ('1','Vishal','Jagwani','Upnagar');
insert into customer (id,firstName,lastName,address)
values ('2','Poonam','Jagwani','Upnagar');
insert into customer (id,firstName,lastName,address)
values ('3','Renuka','Jagwani','Upnagar');
insert into customer (id,firstName,lastName,address)
values ('4','Dwarkadas','Jagwani','Upnagar');
insert into customer (id,firstName,lastName,address)
...
-- -----------------------------------------------------
-- Table `web_medicine_tracker`.`orders`
-- -----------------------------------------------------


CREATE TABLE IF NOT EXISTS `web_medicine_tracker`.`orders` (
    `id` int NOT NULL AUTO_INCREMENT,
...
values ('1','2020/09/06','2','100','1');
insert into orders (id,orderDate,orderQty,orderTotal,customerId)
values ('2','2020/09/06','2','100','2');
insert into orders (id,orderDate,orderQty,orderTotal,customerId)
values ('3','2020/09/06','2','100','3');
insert into orders (id,orderDate,orderQty,orderTotal,customerId)
values ('4','2020/09/06','2','100','3');


-- -----------------------------------------------------
-- Table `web_medicine_tracker`.`stockorder`
-- -----------------------------------------------------


CREATE TABLE IF NOT EXISTS `web_medicine_tracker`.`stockorder` (
